...
use rust_game::components::room::{Door, DoorState, Room, Floor, TargetRoom, Interactable};
...
fn room_transition_loads_new_room() {
    ...
    // Spawn room A entity
    let room_a = app.world_mut().spawn((
        Room {
            id: 0,
            floor: Floor::Ground,
    ...
    let room_b = app.world_mut().spawn((
        Room {
            id: 1,
            floor: Floor::Ground,
...
fn can_query_room_entities_after_transition() {
    ...
    // Spawn room 0
    let room_0 = app.world_mut().spawn((
        Room {
            id: 0,
            floor: Floor::Ground,
    ...
    let room_1 = app.world_mut().spawn((
        Room {
            id: 1,
            floor: Floor::First,
